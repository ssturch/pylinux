...
class OperationHelper(BasePage):
    def enter_text_into_field(self, locator, word, description=None):
        ...
        logging.debug(f'Отправка {word} в элемент {element_name}')
        ...
        try:
            ...
            logging.exception(f'Возникло исключение в элементе {locator}')
            return False
        return True
    ...
    def click_button(self, locator, description=None):
        ...
        try:
            ...
            logging.exception(f'Ошибка нажатия кнопки')
            return False
        logging.debug(f'Нажата кнопка {element_name}')
        return True
    ...
    def get_text_from_element(self, locator, description=None):
        ...
        try:
            ...
            logging.exception(f' Ошибка получения теста для {element_name}')
            return None
