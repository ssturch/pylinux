...
folder_in = "/home/sst/test"
folder_out = "/home/sst/out"
folder_ext = "/home/sst/testfolder1"
folder_ext2 = "/home/sst/testfolder2"
list_of_files = ["testfile1.txt", "testfile2.txt", "testfile3.txt"]
...
def test_step6():
    ...
    res4 = checkout("ls {}".format(folder_ext2), "testfolder")
...
def test_step8():
    # test8
    res1 = checkout("cd {}; 7z h test1file.txt".format(folder_in), "Everything is Ok")
    hash = getout("cd {}; crc32 test1file.txt".format(folder_in)).upper()
    res2 = checkout("cd {}; 7z h test1file.txt".format(folder_in), hash)
